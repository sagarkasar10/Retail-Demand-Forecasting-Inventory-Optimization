WITH source_calendar AS (
    ...
    SELECT
        ...
        NULLIF(TRIM(CAST(event_name_1 AS STRING)), '') AS event_name_1,
        NULLIF(TRIM(CAST(event_type_1 AS STRING)), '') AS event_type_1,
        NULLIF(TRIM(CAST(event_name_2 AS STRING)), '') AS event_name_2,
        NULLIF(TRIM(CAST(event_type_2 AS STRING)), '') AS event_type_2,
