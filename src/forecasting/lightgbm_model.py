...
def prepare_training_data(
    ...
    y = training_df["sales"].astype(float)
...
def train_lightgbm_model(
    ...
    """Train LightGBM with configurable parameters."""
...
def predict_lightgbm(
    ...
    """Generate non-negative LightGBM demand predictions."""
...
def get_model_parameters(
    ...
    """Return the trained LightGBM model parameters."""
